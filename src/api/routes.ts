...
export const verifySessionRoute = new Route(
  MethodTypes.POST,
  sessionRoutes,
  "/verify"
);
...
export const verifyResetRoute = new Route(
  MethodTypes.GET,
  authRoutes,
  "/verify"
);
...
export const getProfileRoute = new Route(
  MethodTypes.GET,
  accountRoutes,
  "/:accountId"
);
export const updateAccountRoute = new Route(
  MethodTypes.PATCH,
  accountRoutes,
  "/:accountId"
);
...
export const uploadCoursesRoute = new Route(
  MethodTypes.POST,
  coursesRoutes,
  ""
);
...
export const authorizeFacebookRoute = new Route(
  MethodTypes.GET,
  facebookRoutes,
  "/authorize"
);
export const deauthorizeFacebookRoute = new Route(
  MethodTypes.GET,
  facebookRoutes,
  "/deauthorize"
);
export const deleteFacebookRoute = new Route(
  MethodTypes.GET,
  facebookRoutes,
  "/delete"
);
export const connectFacebookRoute = new Route(
  MethodTypes.POST,
  facebookRoutes,
  "/connect"
);
...
export const getSpotifyDataRoute = new Route(
  MethodTypes.POST,
  spotifyRoutes,
  ""
);
export const authorizeSpotifyRoute = new Route(
  MethodTypes.GET,
  spotifyRoutes,
  "/authorize"
);
export const getTokenSpotifyRoute = new Route(
  MethodTypes.GET,
  spotifyRoutes,
  "/callback"
);
export const deauthorizeSpotifyRoute = new Route(
  MethodTypes.POST,
  spotifyRoutes,
  "/deauthorize"
);
export const deleteSpotifyRoute = new Route(
  MethodTypes.POST,
  spotifyRoutes,
  "/delete"
);
...
export const authorizeInstagramRoute = new Route(
  MethodTypes.GET,
  instagramRoutes,
  "/authorize"
);
export const deauthorizeInstagramRoute = new Route(
  MethodTypes.POST,
  instagramRoutes,
  "/deauthorize"
);
export const deleteInstagramRoute = new Route(
  MethodTypes.POST,
  instagramRoutes,
  "/delete"
);
...
export const ClientRoute = ((): string => {
  let route;
  if (process.env.NODE_ENV === "development") route = "http://localhost:3000";
  else route = "https://educonnections.ca";
  return route;
})();
