...
var generateURI_1 = __importDefault(require("../../auth/helpers/generateURI"));
var Logger_1 = __importDefault(require("../../../errors/Logger"));
function getAccountHandler(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var id, account, name, email, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = res.locals.token.id;
                    Logger_1.default.Log("Id: ", id);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 2:
                    account = _a.sent();
                    Logger_1.default.Log("Account: ", account);
                    if (!account) {
...
exports.default = getAccountHandler;
